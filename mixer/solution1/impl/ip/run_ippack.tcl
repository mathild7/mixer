...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 lev0 W 0x0 "Data signal of lev0" {{0 32 lev0 W 0 "Bit 31 to 0 Data signal of lev0"}}} {0x18 lev1 W 0x0 "Data signal of lev1" {{0 32 lev1 W 0 "Bit 31 to 0 Data signal of lev1"}}} {0x20 lev2 W 0x0 "Data signal of lev2" {{0 32 lev2 W 0 "Bit 31 to 0 Data signal of lev2"}}} {0x28 lev3 W 0x0 "Data signal of lev3" {{0 32 lev3 W 0 "Bit 31 to 0 Data signal of lev3"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS in0_V in1_V in2_V in3_V out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 22 II x}
...
set enable_xo_gen 0
set kernel_files {/home/hildeb47/proj/ECE1373_GhostSynth/mods/mixer/mixer.cpp}
if {$enable_xo_gen} {
