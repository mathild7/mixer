...
#ifndef __mixer_fcmp_32ns_3dEe__HH__
#define __mixer_fcmp_32ns_3dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_fcmp_32ns_3dEe) {
    ...
    SC_CTOR(mixer_fcmp_32ns_3dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
